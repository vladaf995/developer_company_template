...
const digitalDesignImgeAnimation1 = document.querySelector(".digital-design__image-1-animation");
const digitalDesignImgeAnimation2 = document.querySelector(".digital-design__image-2-animation");
const digitalDesignImgeAnimation3 = document.querySelector(".digital-design__image-3-animation");
const digitalDesignImgeAnimation4 = document.querySelector(".digital-design__image-4-animation");
const digitalDesignImgeAnimation5 = document.querySelector(".digital-design__image-5-animation");
const digitalDesignImgeAnimationCard = document.querySelector(".digital-design__card");
const whatWeDO = document.querySelector('.what-we-do');
const whatWeDoImageAnimation1 = document.querySelector('.what-we-do__second-section__first-img__animation');
const whatWeDoImageAnimation2 = document.querySelector('.what-we-do__second-section__second-img__animation');
const whatWeDoImageAnimation3 = document.querySelector('.what-we-do__second-section__third-img__animation');
const whatWeDoImageAnimation4 = document.querySelector('.what-we-do__second-section__fourth-img__animation');
const whatWeDoImageAnimationCard = document.querySelector(".what-we-do__second-section__card");
...
const weAreTeamAnimationDiv2 = document.querySelector('.we-are-a-team__content');
const contact = document.querySelector('.contact');
const contactImageAnimation1 = document.querySelector('.contact__image-1__animation');
const contactImageAnimation5 = document.querySelector('.contact__image-5__animation');
const contactImageAnimation2 = document.querySelector('.contact__image-2__animation');
const contactImageAnimation3 = document.querySelector('.contact__image-3__animation');
const contactImageAnimation4 = document.querySelector('.contact__image-4__animation');
const contactImageAnimation6 = document.querySelector('.contact__image-6__animation');
const servicesCard = document.querySelectorAll('.services-card__wrapper__card:nth-child(odd)');
const servicesCard2 = document.querySelectorAll('.services-card__wrapper__card:nth-child(even)');
